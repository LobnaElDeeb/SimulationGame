...
public class Simulator implements WorldListener {
	...
	private Citizen getCitizenByLocation(Address location) {
		for (int i = 0; i < citizens.size(); i++) {
			if (citizens.get(i).getLocation() == location)
				return citizens.get(i);
		}
		return null;
	}
	...
	public void nextCycle() throws CannotTreatException, DisasterException {
